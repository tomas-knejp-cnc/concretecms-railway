 ...
 */
class InstanceLog extends \Concrete\Core\Entity\Board\InstanceLog implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'instance', 'dateCreated', 'entries'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (InstanceLog $proxy) {
